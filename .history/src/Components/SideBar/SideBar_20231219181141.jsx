...
export default function SideBar({ HandleToggle }) {
  ...
  return (
    <aside ref={sidebarRef} className={styles.menu}>
      ...
      <div onClick={HandleToggleShoes} className={styles.menu_main_item} id="shoes">
        ...
        {toggleShoes && (
          <div className={styles.shoes_open} id="openedShoes">
            <Link to="/goodspage/oksfords" className={styles.shoes_open_item_link}>
              <div className={styles.shoes_open_item}>Оксфорды</div>
            </Link>
            <Link to="/goodspage/derbi" className={styles.shoes_open_item_link}>
              <div className={styles.shoes_open_item}>Дерби</div>
            </Link>
            <Link to="/goodspage/brogi" className={styles.shoes_open_item_link}>
              <div className={styles.shoes_open_item}>Броги</div>
            </Link>
            <Link to="/goodspage/monki" className={styles.shoes_open_item_link}>
              <div className={styles.shoes_open_item}>Монки</div>
            </Link>
            <Link to="/goodspage/lofers" className={styles.shoes_open_item_link}>
              <div className={styles.shoes_open_item}>Лоферы</div>
            </Link>
            <Link to="/goodspage/chelsi" className={styles.shoes_open_item_link}>
      ...
      <Link to="/payment" className={styles.menu_link} href="">
        <div className={styles.menu_main_item}>
          <div className={styles.menu_main_item_text}>ОПЛАТА И ДОСТАВКА</div>
        </div>
      </Link>

      <Link className={styles.menu_link} to="/contacts">
        <div className={styles.menu_main_item}>
