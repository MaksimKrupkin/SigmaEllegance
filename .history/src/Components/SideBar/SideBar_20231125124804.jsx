...
export default function SideBar() {
  return (
    <aside className={styles.menu}>
      <img className={styles.menu_off} src="/img/крестик.svg" alt="" />
      ...
      <div className={styles.menu_main_item} id="styles">
        ...
        <img
          className={styles.menu_main_item_image}
        ...
        <div className={styles.styles_open} id="openedStyle">
          ...
          <a href="/performance.html" className={styles.style - open - item - link}>
      ...
      <a className={styles.menu_linkt} href="about us.html">
        <div className={styles.menu_main_itemt}>
          <div className={styles.menu_main_item_textt}>О нас</div>
        </div>
      </a>

      <a className={styles.menu_linkt} href="">
        <div className={styles.menu_main_itemt}>
