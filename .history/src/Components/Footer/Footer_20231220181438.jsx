  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.column_1}>
        <Link className={styles.column_title}>О компании</Link>
        ...
        <Link className={styles.column_item}>Политика</Link>
        <Link className={styles.column_item}>Обратная связь</Link>
      </div>
      <div className={styles.column_2}>
        <Link className={styles.column_title}>Поддержка</Link>
      ...
      <div className={styles.column_3}>
        <Link className={styles.column_title}>Магазин</Link>
