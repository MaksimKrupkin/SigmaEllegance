  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.column_1}>
        ...
        <Link to="/contacts" className={styles.column_item}>
          Контакты
        </Link>
        <Link to="/aboutUsPage" className={styles.column_item}>
          О нас
        </Link>
      ...
      <div className={styles.column_2}>
        ...
        <Link to="/payment" className={styles.column_item}>
          Оплата товара
        </Link>
      ...
      <div className={styles.column_3}>
        ...
        <Link to="/goodspage/smokings" className={styles.column_item}>
          Смокинги
        </Link>
        <Link to="/goodspage/pidjac" className={styles.column_item}>
          Пиджаки
        </Link>
        <Link to="/goodspage/bruki" className={styles.column_item}>
          Брюки & Штаны
        </Link>
        <Link to="/goodspage/shirts" className={styles.column_item}>
          Рубашки
        </Link>
      </div>
