...
import image1 from './1';
import image2 from './2';
import image3 from './3';
import image4 from './4';
import image5 from './5';
import image6 from './6';
      ...
      <div className={styles.container}>
        ...
        <div className={styles.items_wrapper}>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.paragraph}>
              Оплатить заказ можно смартфоном или часами, которые поддерживают Samsung Pay, Apple
              Pay или Google Pay.
            </p>
          </div>
          <div className={styles.item}>
