    ...
    <div className="good-container">
      <div className="images-wrapper">
        <div className="images">
          <img claclassNamess="goods-image" src="img/${category}-${number}.webp" alt="" />
          <div className="subimages">
            <img className="goods-subimage" src="img/${category}-${number}-1.webp" alt="" />
            <img className="goods-subimage" src="img/${category}-${number}-2.webp" alt="" />
            <img className="goods-subimage" src="img/${category}-${number}-3.webp" alt="" />
          </div>
        </div>
      </div>
